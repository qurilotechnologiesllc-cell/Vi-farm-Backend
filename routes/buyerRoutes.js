...
const {
  getVendorCategoriesForUser,
  getCategories,
} = require("../controllers/userCategory.controller");

const { upload } = require('../services/cloudinaryService');

const ctrl = require("../controllers/specialCategory.controller");
...
// USER → Vendor-wise categories
router.get('/vendors/:vendorId/categories', getVendorCategoriesForUser);

// Get Special Categories
// PUBLIC
router.get("/special-categories", ctrl.getSpecialCategories);

// Get Special Categories with Products
router.get(
  "/special-categories/with-products",
  ctrl.getSpecialCategoriesWithProducts,
);


// Get Products under a Special Category
router.get(
  "/special-categories/:id/products",
  ctrl.getSpecialCategoryProducts
);
