...
router.post(
  ...
  upload.single("image"),
  ctrl.createSpecialCategory
);

// Update Special Categories
router.put("/admin/special-categories/:id", ctrl.updateSpecialCategory);

// Delete Special Categories
router.delete("/admin/special-categories/:id", ctrl.deleteSpecialCategory);
